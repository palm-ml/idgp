...
def load_mnist(ds, batch_size, device):
    ...
    temp_train = dsets.MNIST(root='data/', train=True, download=True, transform=transforms.ToTensor())
    temp_valid = dsets.MNIST(root='data/', train=True, transform=test_transform)
